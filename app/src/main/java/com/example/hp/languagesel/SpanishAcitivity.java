...
public class SpanishAcitivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    private FirebaseAuth mAuth;
    ImageButton btnFamily;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setNavigationItemSelectedListener(SpanishAcitivity.this);
        UserNameNavDrawer=(TextView)navigationView.getHeaderView(0).findViewById(R.id.username_nav_drawer);
        loadUserInformation();
        btnFamily=(ImageButton) findViewById(R.id.btn_family_spanish);
        btnFamily.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(SpanishAcitivity.this,FamilySpanish.class);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if(id==R.id.profile)
        {
            Toast.makeText(SpanishAcitivity.this,"This is profile",Toast.LENGTH_SHORT).show();
        ...
        {
            mDrawerLayout.closeDrawer(GravityCompat.START,false);
            final AlertDialog.Builder builder=new AlertDialog.Builder(SpanishAcitivity.this);
            ...
            builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    startActivity(new Intent(SpanishAcitivity.this,SignIn.class));
                    finish();
                }
            });
