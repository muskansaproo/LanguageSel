...
public class GermenActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_germen_acitivity);
        ...
        loadUserInformation();
        btnFood=(ImageButton) findViewById(R.id.btn_food_germen);
        btnFood.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(GermenActivity.this,"this is food button",Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if(id==R.id.profile)
        {
            Toast.makeText(GermenActivity.this,"This is profile",Toast.LENGTH_SHORT).show();
        ...
        {
            mDrawerLayout.closeDrawer(GravityCompat.START,false);
            final AlertDialog.Builder builder=new AlertDialog.Builder(GermenActivity.this);
            ...
            builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    startActivity(new Intent(GermenActivity.this,SignIn.class));
                    finish();
                }
            });
