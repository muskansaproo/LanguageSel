...
public class FrenchActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadUserInformation();
        btnFood=(ImageButton) findViewById(R.id.btn_food_french);
        btnFood.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(FrenchActivity.this,"this is food button",Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if(id==R.id.profile)
        {
            Toast.makeText(FrenchActivity.this,"This is profile",Toast.LENGTH_SHORT).show();
        ...
        {
            mDrawerLayout.closeDrawer(GravityCompat.START,false);
            final AlertDialog.Builder builder=new AlertDialog.Builder(FrenchActivity.this);
            ...
            builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    startActivity(new Intent(FrenchActivity.this,SignIn.class));
                    finish();
                }
            });
